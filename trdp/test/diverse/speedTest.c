 ...
 * @file            speedTest.c
 *
 * @brief           Performance test application for TRDP
 *
 * @details         Receive and send process data, single threaded using callbacks
 *
...
/* Some default comId definitions    */

/* Expect receiving AND Send as echo    */
#define PD_COMID1               1000
#define PD_COMID1_CYCLE         10000       /* 10ms cycle time */
#define PD_COMID1_TIMEOUT       PD_COMID1_CYCLE * 3u
#define PD_COMID1_DATA_SIZE     1000        /* 1kByte of changing data */

#define PD_COMID2               1001
#define PD_COMID2_CYCLE         10000       /* 10ms cycle time */
#define PD_COMID2_TIMEOUT       PD_COMID1_CYCLE * 3u
#define PD_COMID2_DATA_SIZE     1000        /* 1kByte of changing data */

#define APP_VERSION         "1.0"

#define GBUFFER_SIZE        PD_COMID1_DATA_SIZE

CHAR8   gSendBuffer[GBUFFER_SIZE]   = "Hello World";
    ...
    UINT32                  dataSize)
{
    ...
    switch (pMsg->resultCode)
    {
       ...
       case TRDP_TIMEOUT_ERR:
           ...
           memset(gInputBuffer, 0, GBUFFER_SIZE);
           break;
       default:
...
{
    printf("Usage of %s\n", appName);
    printf("This tool sends PD messages to an ED and displayes the time of received PD packages.\n"
           "Arguments are:\n"
           "-o own IP address\n"
           "-t target IP address\n"
           "-c expecting comID\n"
...
int main (int argc, char * *argv)
{
    ...
    TRDP_ERR_T              err;
    TRDP_MEM_CONFIG_T       dynamicConfig   = {NULL, 0u, {0}};
    ...
    err = tlp_subscribe( appHandle,                 /*    our application identifier           */
                         ...
                         NULL, myPDcallBack,        /*    userRef & callback function          */
                         comId_In,                  /*    ComID                                */
    ...
    err = tlp_publish(  appHandle,                  /*    our application identifier    */
                        ...
                        (UINT8 *)gSendBuffer,       /*    initial data                  */
    ...
    while (1)
    {
        ...
        sprintf((char *)gSendBuffer, "Ping for the %dth. time.", hugeCounter++);
        err = tlp_put(appHandle, pubHandle, (const UINT8 *) gSendBuffer, GBUFFER_SIZE);
        if (err != TRDP_NO_ERR)
        {
