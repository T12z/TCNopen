...
/**********************************************************************************************************************/
/** Create a Packet socket to use with TSN.
 *  Return a socket descriptor for further calls. The socket options must be applied.
    ...
    BOOL8           doBind)
{
    ...
    /*
     Biding to a device returns an unusable IP address for the interface.
